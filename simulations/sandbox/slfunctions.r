...
## ssize <- function(alpha, beta, p, r2, s2, b) {
##     return((qnorm(1 - alpha / 2) + qnorm(1 - beta))^2 / (p * (1 - r2) * s2 * b^2))
## }

## ppower <- function(n, alpha, p, r2, s2, b) {
##     return(pnorm(sqrt(n * p * (1 - r2) * s2 * b^2) - qnorm(1 - alpha / 2)))
## }


## ppower(50000, 0.05, 0.004, 0.3, 1^2, log(1.27))
